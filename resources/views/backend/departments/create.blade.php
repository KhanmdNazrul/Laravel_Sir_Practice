						...
						<div class="col-md-8 col-md-offset-2">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">New Department creation Form</h6>
									</div>
												...
												<div class="form-wrap">
													<form class="form-horizontal" action="{{route('department.store')}}" method="post">
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<div class="input-group">
																	<input type="text" class="form-control" name="name" id="exampleInputuname_4" placeholder="Username">
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<div class="input-group">
																	<textarea type="text" name="details" class="form-control"  placeholder="Description" rows="10"></textarea>
