								...
								<div class="form-wrap">
									<form class="form-horizontal" action="{{route('appointment.store')}}" method="post">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<div class="input-group">
													<input type="email" class="form-control" name="email" value="{{old('email')}}" id="exampleInputuname_4" placeholder="Username">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<div class="input-group">
													<input type="text" class="form-control" name="phone" value="{{old('phone')}}" id="exampleInputuname_4" placeholder="Username">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<div class="input-group">
													<input type="date" class="form-control" name="date" value="{{old('date')}}" id="exampleInputuname_4" placeholder="Username">
										...
										<div class="form-group">
															<label for="exampleInputEmail_4" class="col-sm-3 control-label">Ramarks*</label>
															<div class="col-sm-9">
																<div class="input-group">
																	<textarea type="text" name="remarks" class="form-control"  placeholder="ramarks" rows="5"></textarea>
